...
#--------------------------------------------------------------------------------------------
export DATA_FILE="/export/server/zabbix/hadoop/${HADOOP_NAME_IN_ZABBIX}_${MONITOR_TYPE}.txt"
export BAK_DATA_FILE="/export/server/zabbix/hadoop/${HADOOP_NAME_IN_ZABBIX}_${MONITOR_TYPE}_bak.txt"
export LOG_FILE="/export/server/zabbix/hadoop/${HADOOP_NAME_IN_ZABBIX}.log"
