...
#--------------------------------------------------------------------------------------------
export DATA_FILE="/export/server/zabbx/hbase/${NAME_IN_ZABBIX}_HBaseMaster.txt"
export BAK_DATA_FILE="/export/server/zabbx/hbase/${NAME_IN_ZABBIX}_HBaseMaster_bak.txt"
export LOG_FILE="/export/server/zabbx/hbase/${NAME_IN_ZABBIX}.log"
