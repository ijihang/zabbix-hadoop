...
#--------------------------------------------------------------------------------------------
export DATA_FILE="/export/server/zabbx/yarn/${NAME_IN_ZABBIX}_YarnRM.txt"
export BAK_DATA_FILE="/export/server/zabbx/yarn/${NAME_IN_ZABBIX}_YarnRM_bak.txt"
export LOG_FILE="/export/server/zabbx/yarn/${NAME_IN_ZABBIX}.log"
